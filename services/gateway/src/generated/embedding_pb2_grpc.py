...
class EmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetModelInfo = channel.unary_unary(
                ...
                request_serializer=embedding__pb2.Empty.SerializeToString,
                response_deserializer=embedding__pb2.ModelInfo.FromString,
                _registered_method=True)
...
def add_EmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetModelInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=embedding__pb2.Empty.FromString,
                    response_serializer=embedding__pb2.ModelInfo.SerializeToString,
            ),
    }
...
class EmbeddingService(object):
    ...
    def GetModelInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/embedding.EmbeddingService/GetModelInfo',
            embedding__pb2.Empty.SerializeToString,
            embedding__pb2.ModelInfo.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
