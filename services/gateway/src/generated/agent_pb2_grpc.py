...
class AgentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ResumeChat = channel.unary_stream(
                '/agent.AgentService/ResumeChat',
                request_serializer=agent__pb2.ResumeRequest.SerializeToString,
                response_deserializer=agent__pb2.ChatResponse.FromString,
                _registered_method=True)
...
def add_AgentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResumeChat': grpc.unary_stream_rpc_method_handler(
                    servicer.ResumeChat,
                    request_deserializer=agent__pb2.ResumeRequest.FromString,
                    response_serializer=agent__pb2.ChatResponse.SerializeToString,
            ),
    }
...
class AgentService(object):
    ...
    def ResumeChat(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/agent.AgentService/ResumeChat',
            agent__pb2.ResumeRequest.SerializeToString,
            agent__pb2.ChatResponse.FromString,
            options,
            channel_credentials,
            insecure,
